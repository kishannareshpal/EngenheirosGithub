var cadeiras1oSemIDS_vias = ["betao2", "estruturas", "gqc", "viasferreas", "viasrodoviarias1", "antropologia"]
var cadeiras2oSemIDS_vias = ["drenagemviaria", "trafego", "pontes", "projecto", "praticas", "viasrodoviarias2"]
var cadeiras1oSemIDS_obras = ["betao2", "recursoshidricos", "gqc", "hidrogeologia", "hidrometria", "hidroquimica", "antropologia"]
...
var cadeiras2oSemIDS_edificios = ["instalacoes2", "patologia", "praticas", "projconstrucao", "reabilitacao", "tecnicanaoconvecional"]

var cadeiras1oSemNAMES_vias = ["Betão II", "Estruturas Metálicas e de Madeira", "Gestão de Qualidade na Construção", "Vias Férreas", "Vias Rodoviárias I", "TT: Antropologia Cultural de Moçambique"]
var cadeiras2oSemNAMES_vias = ["Drenagem Viária", "Engenharia de Tráfego", "Pontes", "Projecto Viário", "Práticas de Estaleiro e de Obras de Vias", "Vias Rodoviárias II"]
...
var cadeiras1oSemNAMES_edificios = ["Betão II", "Edificações", "Estruturas Metálicas e de Madeira", "Gestão de Qualidade na Construção", "Instalações em Edifícios I", "TT: Antropologia Cultural de Moçambique"]
var cadeiras2oSemNAMES_edificios = ["Instalações em Edifícios II", "Patologia em Edifícios", "Práticas de Estaleiro e Obras de Edifícios", "Projecto de Construção de Edifícios", "Reabilitação de Estruturas e Materiais", "Técnica de Construçõa Não-Convencional"]
